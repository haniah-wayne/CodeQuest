				...
				<form onSubmit={handleSubmit} className="space-y-6">
					<div>
						...
						<div className="relative rounded-md shadow-sm">
							...
							<input
								type="email"
								className="w-full rounded-xl border border-gray-200 py-3 pl-10 transition-all outline-none focus:border-transparent focus:ring-2 focus:ring-indigo-500"
					...
					<div>
						...
						<select
							className="w-full rounded-xl border border-gray-200 px-3 py-3 transition-all outline-none focus:border-transparent focus:ring-2 focus:ring-indigo-500"
							value={role}
