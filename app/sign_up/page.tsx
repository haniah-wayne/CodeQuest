...
export default function LoginForm() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		{
			/*commented out error handling until merged with other branches */
		}
		{
		...
		<div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-100">
			<div className="w-full max-w-md rounded-2xl border border-gray-100 bg-white p-8 shadow-lg">
				<div className="mb-8 text-center">
					<h2 className="mb-2 text-3xl font-bold text-gray-800">Welcome New User</h2>
				...
				<form onSubmit={handleSubmit} className="space-y-6">
					...
					<div>
						...
						<input
							type="text"
							className="w-full rounded-xl border border-gray-200 px-3 py-3 text-black transition-all outline-none focus:border-transparent focus:ring-2 focus:ring-indigo-500"
							value={firstName}
